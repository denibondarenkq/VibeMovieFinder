...
final class MovieDetailSectionsView: UIView {
    ...
    private func setupConstraints() {
        ...
        NSLayoutConstraint.activate([
            loadingSpinnerView.widthAnchor.constraint(equalToConstant: 100),
            loadingSpinnerView.heightAnchor.constraint(equalToConstant: 100),
    ...
    private func registerCells(for collectionView: UICollectionView) {
        collectionView.register(BackdropCollectionViewCell.self, forCellWithReuseIdentifier: BackdropCollectionViewCell.cellIdentifier)
    ...
    private func createSectionLayout(for sectionIndex: Int) -> NSCollectionLayoutSection {
        ...
        case .overview:
            strategy = DefaultSectionLayoutStrategy(groupWidth: .fractionalWidth(0.93), groupHeight: .absolute(130))
        case .genres:
...
extension MovieDetailSectionsView: UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        case .backdrop(let viewModel):
            guard let cell = collectionView.dequeueReusableCell(
                withReuseIdentifier: BackdropCollectionViewCell.cellIdentifier,
                for: indexPath
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        case .recommendations:
            guard let movie = viewModel?.movieRecommendation(at: indexPath.row) else { return }
